	...
	<div id="primary" class="content-area">
		...
		<div class="browse-options">
			<section class="browse-teaser">
				...
				<p>Listicle literally pour-over street art quinoa scenester. Mumblecore fap Blue Bottle narwhal craft beer, Bushwick keytar +1 Carles High Life fingerstache Etsy cronut locavore mixtape. Etsy messenger bag Echo Park, Pitchfork whatever Tumblr cliche brunch hashtag blog.</p>
			</section>
			<section class="browse-teaser">
				<h2><small>Browse by</small> Location</h2>
				<p>Schlitz tofu skateboard Carles. Quinoa Truffaut lomo, sartorial fashion axe iPhone art party fap salvia.</p>
			</section>
			<section class="browse-teaser">
